...
if (isset($_POST["btnOK"])) {
  ...
  //$row如果輸入帳號密碼符合，表示有紀錄session=true，登入成功
  //$total如果記錄數大於0，表示有紀錄session=true，登入成功
...
if (isset($_POST["okButton"])) {
  ...
  if ($row == null) {
    $link = mysqli_connect("localhost", "root", "root", "insider");
    $sqlCommand = "INSERT INTO `userInfo` (`uid`, `account`, `password`, `Name`, `phone`) VALUES (NULL, '$user', '$psw', '$userNamel', '$phone');";
    $total = mysqli_query($link, $sqlCommand);
  ...
  <div class="container_inner">
    ...
    <div class="header_inner">
      <div class="head" id="top">
        <div class="logo ">
          <a href="campig.html"><img src="./image/header/logo_block_1.jpg" alt="logo" style="width:150px; height:50px;"></a>
        </div>

        <div class="header_right">
          <?php if ($userName == "Guest") { ?>
            <a href="login.php"><img src="./image/header/user-solid.svg" alt="person" style="width: 35px; height:35px;"></a>
          <?php } else { ?>
            <span><?= "Hi ! " . $userName ?></span>
          <?php } ?>
          <a href="pay.html"><img src="./image/header/cart-shopping-solid.svg" alt="shoppingcar" style="width: 35px; height:35px; margin: 0 20px;"></a>
        ...
        <div class="content">
          <div style="display: block;" class="box1">
            <form action="" method="post">
              ...
              <!-- <input type="password" name="txtPassWord" value=" pattern="[A-Z]{1}[a-z]{1}[0-9]{6}"> -->
              <br>
          ...
          <div class="box2">
            <form action="login.php" method="post">
              ...
              <input type="text" placeholder="" name="phone" value="" maxlength="10" pattern="^09[0-9]{8}" required>
              <br>
              <input type="checkbox" name="agree"><label>我同意網站服務條例及隱私政策</label>
              <br>
              <!-- <button id="myBtn2">註冊</button> -->
              <input class='popuptest' id type="submit" name="okButton" value="送出">
              <!-- <p class='show'></p> -->
          </div>
          </form>
        </div>
    ...
    <div class="footer_inner">
      <div class="footer_middel">
        ...
        <div class="store">
          <img src="./img/map.jpg" alt="logo" style="width:200px; height:100px; margin: 0 30px 10px 0;">
          <div>
            電話：
